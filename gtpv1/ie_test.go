...
// 		if got := gtpv1.NameOfIEForType(testCase.ieType); got != testCase.expectedName {
...
// 		_, err := gtpv1.DecodeIE(testCase.inputStream)
...
// 	for _, testCase := range cases {
// 		testCaseNumber++
// 		ie, err := gtpv1.DecodeIE(testCase.ieOctets)
...
// 		{
// 			fteid:             &gtpv1.TypedFTEID{IPv4Addr: nil, IPv6Addr: nil, InterfaceType: 1, Key: 0xaabbccdd},
// 			expectedDataBytes: []byte{0x01, 0xaa, 0xbb, 0xcc, 0xdd},
// 		},
// 		{
// 			fteid:             &gtpv1.TypedFTEID{IPv4Addr: net.ParseIP("10.11.12.13"), IPv6Addr: nil, InterfaceType: 1, Key: 0xaabbccdd},
// 			expectedDataBytes: []byte{0x81, 0xaa, 0xbb, 0xcc, 0xdd, 0x0a, 0x0b, 0x0c, 0x0d},
// 		},
// 		{
// 			fteid:             &gtpv1.TypedFTEID{IPv4Addr: nil, IPv6Addr: net.ParseIP("fd00:a:b:c:d::1"), InterfaceType: 1, Key: 0xaabbccdd},
...
// 		},
// 		{
// 			fteid:             &gtpv1.TypedFTEID{IPv4Addr: net.ParseIP("10.11.12.13"), IPv6Addr: net.ParseIP("fd00:a:b:c:d::1"), InterfaceType: 1, Key: 0xaabbccdd},
...
// 			ie, err := gtpv1.NewIEWithRawDataErrorable(gtpv1.FTEID, testCase.expectedDataBytes)
...
// 				} else {
// 					fteid := typedFteid.(*gtpv1.TypedFTEID)
...
// 		{
// 			imsi:              &gtpv1.TypedIMSI{AsString: "001002789012345"},
...
// 		} else {
// 			imsi := typedImsi.(*gtpv1.TypedIMSI)
...
// 	ie, err := gtpv1.NewGroupedIEErrorable(gtpv1.BearerContext, []*gtpv1.IE{
// 		gtpv1.NewIEWithRawData(gtpv1.EBI, []byte{0x01}),
// 		(&gtpv1.TypedFTEID{IPv4Addr: net.IPv4(10, 11, 12, 13), InterfaceType: 1, Key: 0xaabbccdd}).ToIE(),
// 		(&gtpv1.TypedFTEID{IPv4Addr: net.IPv4(1, 2, 3, 4), InterfaceType: 3, Key: 0x01020344}).ToIE(),
// 	})
...
// 	extractedIEs, err := gtpv1.ExtractGroupedIEsFrom(ie)
// 	if err != nil {
...
// 		} else {
// 			if extractedIEs[0].Type != gtpv1.EBI {
// 				t.Errorf("[TestGroupIECreation] On re-extract of grouped IEs, expected type of ie[0] to be EBI, got = %s", gtpv1.NameOfIEForType(extractedIEs[0].Type))
// 			}
// 			if extractedIEs[1].Type != gtpv1.FTEID {
// 				t.Errorf("[TestGroupIECreation] On re-extract of grouped IEs, expected type of ie[1] to be FTEID, got = %s", gtpv1.NameOfIEForType(extractedIEs[0].Type))
// 			}
// 			if extractedIEs[2].Type != gtpv1.FTEID {
// 				t.Errorf("[TestGroupIECreation] On re-extract of grouped IEs, expected type of ie[2] to be FTEID, got = %s", gtpv1.NameOfIEForType(extractedIEs[0].Type))
// 			}
// 		}
// 	}
// }
...
// func compareTwoIEObjects(expected *gtpv1.IE, got *gtpv1.IE) error {
// 	if expected.Type != got.Type {
// 		return fmt.Errorf("Expected IE Type [%d] (%s), got [%d] (%s)", expected.Type, gtpv1.NameOfIEForType(expected.Type), got.Type, gtpv1.NameOfIEForType(got.Type))
// 	}
